...
void MyEventReceiver::ApplyGUIParametersToWorld()
{
    ...
    _core->timerModule->setTime(8); // Will later get new time from UI (8 is dawn start)
	...
	_core->particleModule->setWeather(_context.climatRadioBox->getSelected(), _context.climatIntensityRadioBox->getSelected());
